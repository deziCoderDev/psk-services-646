          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="h-8 w-8 relative">
                <img
                  src="/dezi-uploads/8acfad30-aa90-4edd-b779-aafd43058584.png"
            ...
            <p className="text-gray-300 max-w-md">
              Professional sound and light rental service for events, concerts,
              and parties. Turning your events into unforgettable experiences.
            </p>
