        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-psyco-black-DEFAULT to-transparent flex flex-col justify-end p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    Complete sound system and dynamic lighting setup for the
                    main stage, serving an audience of 15,000 people.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="glassmorphism p-1 h-full animate-fade-in animation-delay-100">
              <div className="relative h-full w-full overflow-hidden rounded-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-psyco-black-DEFAULT to-transparent flex flex-col justify-end p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    Custom lighting design incorporating brand colors and theme
                    elements, with pristine audio for presentations and live
                    music.
                  </p>
                </div>
              </div>
            ...
            <div className="glassmorphism p-1 h-full animate-fade-in animation-delay-200">
              <div className="relative h-full w-full overflow-hidden rounded-xl">
                <img
                  src="/dezi-uploads/48e75083-18aa-4df9-bc91-8515485aa465.png"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-psyco-black-DEFAULT to-transparent flex flex-col justify-end p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    Professional PA system installation providing crystal-clear
                    sound coverage for the entire Industry City Stage in
