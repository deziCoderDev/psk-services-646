  ...
  const mainServices = [
    {
      ...
      image: "/dezi-uploads/708f9e32-840d-46a4-aaa4-75ad2689e16f.png",
      features: [
    ...
    },
    {
      ...
      image: "/dezi-uploads/becfc2e3-b59f-4f86-afca-b9f6fc7b7c14.png",
      features: [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1516873240891-4bf014728d44?auto=format&fit=crop&q=80",
      features: [
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 animate-fade-in animation-delay-100">
              Professional sound and lighting solutions for events of all sizes.
              From intimate gatherings to large-scale productions, we have the
              expertise and equipment to make your event exceptional.
            </p>
            <Link
              to="/booking"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="glassmorphism p-8 md:p-12 text-center">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto mb-8">
              Our team of experts is ready to help you plan and execute the
              perfect audio-visual experience for your event.
            </p>
