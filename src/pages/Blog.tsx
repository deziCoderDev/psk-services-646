  ...
  const blogPosts = [
    {
      ...
      category: "Sound",
      imageSrc: "/dezi-uploads/8dced82a-6a2c-48ee-a060-463c28764183.png",
      featured: true,
    },
    {
      id: "2",
    ...
    },
    {
      ...
      excerpt:
        "Understanding the technical requirements for performers and how to prepare your venue to meet these specifications.",
      date: "June 30, 2023",
      readTime: "9 min read",
      author: "Michael Stevens",
      category: "Technical",
      imageSrc:
        "https://images.unsplash.com/photo-1608749333098-a1783ca4b4bf?auto=format&fit=crop&q=80",
    },
  ];

  const categories = ["All", "Sound", "Lighting", "DJ", "Technical"];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 animate-fade-in animation-delay-100">
              Industry knowledge, technical tips, and event inspiration from our
              expert team
            </p>
          </div>
